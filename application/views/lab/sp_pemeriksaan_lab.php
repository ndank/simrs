...
<body onload="cetak()" style="height:auto; width:21.5cm">
    ...
    <table width="100%" cellspacing="0" style="margin-top:30px">
        <tr>
            <td width="50%" align="center"><span style="font-size: 12px;font-weight:bold;">SURAT PEMESANAN PEMERIKSAAN LABORATORIUM KLINIK</span></td>
        </tr>
    </table><br/><br/>
   ...
   <table style="margin-top: 6em;padding:10px;">
        <tr>
         ...
         <tr>
            <td width="50%" align="left">Dokter Pemesan</td>
        </tr>
     </table>
