...
<body onload="cetak()" style="height:auto; width:21.5cm">
    ...
    <p style="text-align:center;font-size:14px;margin-bottom:0px; ">
        <span style="border-bottom:1px solid #000;font-weight:bold;">SURAT JAWABAN RUJUKAN</span>
    </p>
    <p style="margin-top:5px;text-align:center;">No. ..............................</p>

    <table class="table-tujuan" width="100%" style="margin-top: 5em">
        <tr><td>Kepada:</td></tr>
        <tr><td>Yth. <?= $pasien->nakes_perujuk ?></td></tr>
        <tr><td><?= $pasien->relasi ?></td></tr>
        <?php
            $wil = $this->m_pendaftaran->get_wilayah_relasi_instansi($pasien->rujukan_instansi_id);
        ?>
        <tr><td>Di  <?php if($wil != null){ echo $wil->kecamatan.", ".$wil->kabupaten;} ?> </td></tr>
        
     </table>

     <p>Mohon pemeriksaan dan pengobatan lebih lanjut terhadap penderita,</p>
     <table width="100%" style="margin-left:50px;">
        <tr><td width="30%">NO. REGISTRASI:</td><td><?= $pasien->no_daftar ?></td></tr>
        ...
        <tr><td colspan="2">RENCANA TINDAK LANJUT YANG DIANJURKAN:</td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">
            <ul>
            <?php foreach ($lanjut as $key => $value): ?>
                <?php if($value->rencana_tindak_lanjut != ''): ?>
                <li><?= $value->rencana_tindak_lanjut ?></li>
                <?php endif; ?>
            <?php endforeach;?>
            </ul>
        </span></td></tr>
        <tr><td>&nbsp;</td><td></td></tr>
        <tr><td>HASIL PEMERIKSAAN:</td><td></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td>DIAGNOSA:</td><td></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td>PERAWATAN YANG SUDAH DILAKUKAN:</td><td></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
        <tr><td colspan="2"><span style="margin-left:50px;">...........................................................................................................................................................................................................................................</span></td></tr>
    ...
    <p>Demikian balasan surat rujukan ini kami kirim. Atas Perhatian Bapak/Ibu/Sdr./i kami mengucapkan terimakasih</p>
